...
#Onset detection
onsets_envelope = librosa.onset.onset_strength(y=y1, sr=fs, hop_length=hoplen)
onsets = librosa.onset.onset_detect(y=y1, sr=fs, hop_length=hoplen, units='frames', onset_envelope=onsets_envelope, backtrack=True)
onsets_time = librosa.frames_to_time(onsets, sr=fs)
print(onsets)
